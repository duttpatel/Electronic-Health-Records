<?php include("AddAllergyCode.php"); 

if(isset($_GET['edit']))
{
		$id=$_GET['edit'];
		$edit_state=true;
		$rec=mysqli_query($con,"select * from allergy where Id=$id");
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> Allergy <small></small></h2>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="AddAllergyCode.php">
						<input type="hidden" name="id" value="<?php echo $id; ?>" />
                      <div class="form-group">
					  
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Allergy Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						
                          <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="allergyname" value="<?php echo $allergyname; ?>">
                        </div>
                      </div>
					  
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Select Drug</label>
                       <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control col-md-7 col-xs-12" name="drugid" value="<?php echo $drugid;?>" >
						  <?php
						  $string1="select * from drug";
						  $result1=mysqli_query($con,$string1);
						  while($row1=mysqli_fetch_assoc($result1))
						  	{
                            	echo "<option value='" . $row1['DrugId'] . "'>" . $row1['DrugName'] . "</option>";
							}
							?>
                          </select>
                        </div>
...
<table class="table">
	...
	<?php while($row=mysqli_fetch_array($result)){ ?>
			...
			<td>
				<a class="btn btn-primary" href="AddAllergy.php?edit=<?php echo $row['Id']; ?>">Edit</a>
			</td>
			<td>
				<a class="btn btn-primary" href="AddAllergyCode.php?del=<?php echo $row['Id']; ?>">Delete</a>
			</td>		
		</tr>
		<?php } ?>
	</tbody>
