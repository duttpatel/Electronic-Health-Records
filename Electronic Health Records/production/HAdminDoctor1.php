...
$hos=$_POST["hos"];
		...
		include("conn.php");
			...
			$res=mysqli_query($con,"insert into Doctor(FirstName,LastName,Gender,DOB,ContactNumber,Degree,HospitalId) values ('$fn','$ln','$gen','$dob','$cn','$deg','$hos')");
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> Register Doctor <small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="user">
                        </div>
                      </div>
...
<?php
	...
	$result=mysqli_query($con,"insert into login(Username,Password,UserType) values('$user','$pass','$type')");
	$result=mysqli_query($con,"update doctor set Email='$user' where DoctorId=$did");
	echo "<script>
    alert ('Doctor Added');
	window.location.href='HAdminDoctor.php';
    </script>";
