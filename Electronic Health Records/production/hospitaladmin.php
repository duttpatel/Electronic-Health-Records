<?php include("hospitaladmincode.php"); 
$hname="";
$user="";
$pass="";
if(isset($_GET['edit']))
{
		$did=$_GET['edit'];
		$edit_state=true;
		$rec=mysqli_query($con,"select * from hospitaladmin where Id=$did");
		$record=mysqli_fetch_array($rec);
		$hname=$record['HospitalId'];
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  method="post" action="hospitaladmincode.php">
					  ...
					  <div class="form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control col-md-7 col-xs-12" name="hospital_txt" value="<?php echo $spec;?>" >
						  <?php
						  $string1="select * from hospital";
						  $result1=mysqli_query($con,$string1);
						  while($row1=mysqli_fetch_assoc($result1))
						  	{
                            	echo "<option value='" . $row1['HospitalId'] . "'>" . $row1['HospitalName'] . "</option>";
							}
							?>
                          </select>
                        </div>
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" placeholder="House No" name="user_txt" value ="<?php echo $user; ?>">
                        </div>
                      </div>
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" placeholder="City" name="pass_txt" value ="<?php echo $pass;?>">
                        </div>
                      </div>
...
<table class="table">
	...
	<?php while($row=mysqli_fetch_array($result)){ ?>
			...
			<td>
			<?php
				 $string1="select HospitalName from hospital where HospitalId=".$row['HospitalId'];
				$result1=mysqli_query($con,$string1);
				$row1=mysqli_fetch_assoc($result1);
				echo $row1['HospitalName'];
				//echo $string1;
			?>
			</td>
			<td>
			...
			<td>
				<a class="btn btn-primary" href="hospitaladmin.php?edit=<?php echo $row['Id']; ?>">Edit</a>
			</td>
			<td>
				<a class="btn btn-primary" href="hospitaladmincode.php?del=<?php echo $row['Id']; ?>">Delete</a>
			</td>		
		</tr>
		<?php } ?>
	</tbody>
