...
<html lang="en">
  <head>
	...
	function hospitalchange(str)
	{
        ...
        xmlhttp.open("GET","getdoctorid.php?q="+str,true);
        xmlhttp.send();
    }
	}
	...
	function getprescription(str)
	{
        ...
        xmlhttp.open("GET","getpres.php?q="+str,true);
        xmlhttp.send();
    }
	}
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <select name="hospital" id="hid" onChange="hospitalchange(this.value)">
				...
				<select name="doctor" id="did" onChange="getprescription(this.value)">
