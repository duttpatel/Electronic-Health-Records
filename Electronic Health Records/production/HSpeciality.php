<?php include("hspecode.php"); 

if(isset($_GET['edit']))
{
		$sid=$_GET['edit'];
		$edit_state=true;
		$rec=mysqli_query($con,"select * from hspeciality where Sid=$sid");
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i>Hospital Speciality <small></small></h2>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="hspecode.php">
...
<table class="table">
	...
	<?php while($row=mysqli_fetch_array($result)){ ?>
			...
			<td>
				<a class="btn btn-primary" href="hspeciality.php?edit=<?php echo $row['Sid']; ?>">Edit</a>
			</td>
			<td>
				<a class="btn btn-primary" href="hspecode.php?del=<?php echo $row['Sid']; ?>">Delete</a>
			</td>		
		</tr>
		<?php } ?>
	</tbody>
