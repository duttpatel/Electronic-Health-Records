          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Confirm Appointment <small></small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo "AppointCode.php";?>">
					...
					<?php 
						...
						//$query="Select AppointmentId,PatientId,HospitalId,Purpose,ADate from appointment where status='no' and DoctorId=$did";
					...
					<tr>
						...
						<td><a class="btn btn-primary" href="AppointCode.php?edit=<?php echo $row['AppoinmentId']; ?>">Confirm</a></td>
						<td><a class="btn btn-primary" href="AppointCode.php?del=<?php echo $row['AppoinmentId']; ?>">Delete</a></td>
					</tr>
					<?php } ?>
