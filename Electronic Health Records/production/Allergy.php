                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Prescription <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="WritePrescription1.php">Write Prescription</a></li>
					  <li><a href="CurrentStatus.php">Add Current Status</a></li>
					   <li><a href="Allergy.php">Add Allergy</a></li>
				   ...
				   <li><a><i class="fa fa-desktop"></i> View Details <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="viewprescription.php">Previous Precriptions</a></li>
                      <li><a href="MedicalHistory.html">Medical History</a></li>
					  <li><a href="ViewTestResult.php">Test Results</a></li>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="AllergyCode.php">
                     ...
                     <div class="form-group">
					   ...
					   <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12" style="right:185px;">Allergy ID</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<input list="allergy_id" class="form-control col-md-7 col-xs-12" style="right:200px;" name="allergyid" id="aid">
						<datalist id="allergy_id">
						...
						{
						?>
						<option value="<?php echo $row['Id'];?>"><?php echo $row['AllergyName'];?></option>
						<?php } ?>
						</datalist>
