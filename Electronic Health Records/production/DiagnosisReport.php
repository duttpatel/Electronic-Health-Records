                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Manage <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
					  ...
					  <li><a href="HAdmin.html">Hospital Admin</a></li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> Diagnosis <small></small></h2>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Diagnosis Report <small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
...
<table class="table" id="example">
	...
	$query="select doctor.FirstName as dfn,doctor.LastName as dlm,patient.FirstName as pfm,patient.LastName as plm,prescription.PrescriptionDate as pd,prescription.notes as df from doctor,patient,prescription where doctor.DoctorId=prescription.DoctorId and prescription.PatientId=patient.PatientId";
	$result=mysqli_query($con,$query);
	 while($row=mysqli_fetch_array($result)){ ?>
			
			<tr>
			<td><?php echo $row['pfm'].$row['plm'];?></td>
			<td><?php echo $row['dfn'].$row['dlm'];?></td>
    ...
    <script> $1123 = jQuery.noConflict();</script>
