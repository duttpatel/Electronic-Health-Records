            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  method="post" action="hospitalcode.php">
						<input type="hidden" name="did" value="<?php echo $did; ?>" />
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" >Hospital Name 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" placeholder="Hospital Name" name="hospital_name_txt" value ="<?php echo $hname;?>">
                        </div>
                      </div>
					  
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Select Speciality</label>
                       <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control col-md-7 col-xs-12" name="hospital_special_txt" value="<?php echo $spec;?>" >
						  <?php
						  $string1="select * from hspeciality";
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" placeholder="House No" name="hospital_house_txt" value ="<?php echo $house; ?>">
                        </div>
                      </div>
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" placeholder="City" name="hospital_city_txt" value ="<?php echo $city;?>">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" placeholder="Street" name="hospital_street_txt" value ="<?php echo $street;?>">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" placeholder="Pincode" name="hospital_pincode_txt" value ="<?php echo $pincode;?>">
                        </div>
                      </div>
...
<table class="table">
	...
	<?php while($row=mysqli_fetch_array($result)){ ?>
			...
			<td>
				<a class="btn btn-primary" href="hospital.php?edit=<?php echo $row['HospitalId']; ?>">Edit</a>
			</td>
			<td>
				<a class="btn btn-primary" href="hospitalcode.php?del=<?php echo $row['HospitalId']; ?>">Delete</a>
			</td>		
		</tr>
		<?php } ?>
	</tbody>
