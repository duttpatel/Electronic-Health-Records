                    ...
                    <div class="col-md-3 col-sm-4">
                      <aside class="sidebar">
                        ...
                        <div class="sidebar-widget">
                          ...
                          <h3>My Chart</h3>
                          <ul>
                            <li><a href="#"><span class="fa fa-angle-right"></span>My Profile</a></li>
                      ...
                      <div class="blog-content">
					   <div class="single-Blog">
                        ...
                        <form class="appointment-form" data-parsley-validate class="form-horizontal form-label-left" method="post" action="AppointmentCode.php">
						  ...
						  <tr>
                            ...
                            <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Patient Id<span class="required">*</span>
                              ...
                              <td><input type="text" class="wp-form-control wpcf7-text" placeholder=" Enter Patient Id" name="pid" value="<?php echo $_SESSION['UID'];?>" readonly="readonly"></td>
                            </div>
							</tr>
							<!--</div>-->
							<!--<div class="row">-->
                           <tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Date <span class="required">*</span>
                              </label></td>
                             <td> <input type="date" class="wp-form-control wpcf7-email" placeholder="" name="adate"></td>  
                            </div>
							</tr>
							
							 <tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Time <span class="required">*</span>
                              </label></td>
                             <td> <input type="time" class="wp-form-control wpcf7-email" placeholder="" name="atime"></td>  
                            </div>
							</tr>
							
							 <tr> <div class="col-md-6 col-sm-6">
							 <td>
                              <label class="control-label">Select Hospital <span class="required">*</span>
                              </label></td><td><select class="wp-form-control wpcf7-select" id="gender_txt" name="hid">
							  <?php
							 ...
							 <td>
                              ...
                              </label></td><td><select class="wp-form-control wpcf7-select" id="gender_txt" name="did">
							   <?php
							  ...
							  ?>
                                ...
                                <option value="<?php echo $row1['DoctorId']; ?>"><?php echo $row1['FirstName'].$row1['LastName'];?></option>
                                <?php } ?>
                              </select> 
							  </td>
                            </div>
							 ...
							 <tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Purpose <span class="required">*</span>
                              </label></td>
                             <td> <input type="text" class="wp-form-control wpcf7-email" placeholder="Purpose of appointment" name="purpose"></td>  
                            </div>
							</tr>
							
							<tr>
							<td colspan="2"><button class="wpcf7-submit button--itzel" type="submit" name="submit"><i class="button__icon fa fa-share"></i><span>Book Appointment</span></button>  </td>
							</tr>
							</table>
