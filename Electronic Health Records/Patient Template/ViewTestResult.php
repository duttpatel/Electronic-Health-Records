                    ...
                    <div class="col-md-3 col-sm-4">
                      ...
                      <div class="blog-content">
					   <div class="single-Blog">
                        ...
                        <form class="appointment-form" data-parsley-validate class="form-horizontal form-label-left" method="post" action="">
						
                         <!-- <div class="row">-->
						 <h4>Test Results</h4><hr>
						  ...
						  <table class="table">
						   ...
						   <tbody>
						   <?php
						   $results=mysqli_query($con,"select * from testresults where PatientId='$pid'");
							...
							<td><a href="/test/Electronic Health Records/production/<?php echo"$row[Path]"?>"> Click Here </a></td>
							</tr>
							<?php }?>
						   </tbody>
