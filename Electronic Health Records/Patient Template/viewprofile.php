                    ...
                    <div class="col-md-3 col-sm-4">
                      ...
                      <div class="blog-content">
					   <div class="single-Blog">
                        ...
                        <form class="appointment-form" data-parsley-validate class="form-horizontal form-label-left" method="post" action="updateprofile.php">
						
                         <!-- <div class="row">-->
						 <h4>Appointment Details</h4><hr>
						 <?php
						 ...
						 ?>
						  ...
						  <tr>
                            ...
                            <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Patient Id<span class="required">*</span>
                              </label></td>
                              <td><input type="text" class="wp-form-control wpcf7-text" placeholder=" Enter Patient Id" name="Id" value="<?php echo $_SESSION['UID'];?>" readonly="readonly"></td>
                            </div>
							</tr>
							<!--</div>-->
							<!--<div class="row">-->
                           <tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">First Name <span class="required">*</span>
                              </label></td>
                             <td> <input type="text" class="wp-form-control wpcf7-email" placeholder="" name="FirstName" value="<?php echo $row['FirstName'];?>"></td>  
                            </div>
							</tr>
							
							<tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Middle Name <span class="required">*</span>
                              </label></td>
                             <td> <input type="text" class="wp-form-control wpcf7-email" placeholder="" name="MiddleName" value="<?php echo $row['MiddleName'];?>"></td>  
                            </div>
							</tr>
							
							 <tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Last Name <span class="required">*</span>
                              </label></td>
                             <td> <input type="text" class="wp-form-control wpcf7-email" placeholder="" name="LastName" value="<?php echo $row['LastName'];?>"></td>  
                            </div>
							</tr>
							
							
							<tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Birth Date <span class="required">*</span>
                              </label></td>
                             <td> <input type="date" class="wp-form-control wpcf7-email" placeholder="" name="DOB" value="<?php echo $row['DOB'];?>"></td>  
                            </div>
							</tr>
							
							<tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Height <span class="required">*</span>
                              </label></td>
                             <td> <input type="text" class="wp-form-control wpcf7-email" placeholder="Height" id="height_txt" name="Height" value="<?php echo $row['Height'];?>"></td>  
                            </div>
							</tr>
							
							<tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Weight<span class="required">*</span>
                              </label></td>
                             <td> <input type="text" class="wp-form-control wpcf7-text" placeholder="Weight" id="weight_txt" name="Weight" value="<?php echo $row['Weight'];?>"></td>  
                            </div>
							</tr>
							
							<tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Blood Group <span class="required">*</span>
                              </label></td>
                             <td> <select class="wp-form-control wpcf7-select" id="bloodgroup_txt" name="BloodGroup" value="<?php echo $row['BloodGroup'];?>">
							...
							<tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Address<span class="required">*</span>
                              </label></td>
                             <td><textarea class="wp-form-control" cols="5" rows="4" placeholder="Your Address" name="Address" value=""><?php echo $row['Address'];?></textarea></td>  
                            </div>
							</tr>
							
							<tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Contact Number<span class="required">*</span>
                              </label></td>
                             <td><input type="text" class="wp-form-control wpcf7-email" placeholder="Contact Number" id="contact_txt" name="ContactNumber" value="<?php echo $row['ContactNumber'];?>"></td>  
                            </div>
							</tr>
							
							<tr> <div class="col-md-6 col-sm-8">
                             <td> <label class="control-label">Emergency Contact Number<span class="required">*</span>
                              </label></td>
                             <td><input type="text" class="wp-form-control wpcf7-email" placeholder=" Emergency Contact Number" id="econtact_txt" name="EContactNumber" value="<?php echo $row['EContactNumber'];?>"></td>  
                            </div>
							</tr>
							
							<tr> <div class="col-md-6 col-sm-8">
                             <td> <<label class="control-label">Email<span class="required">*</span>
                              </label></td>
                             <td><input type="text" class="wp-form-control wpcf7-text" placeholder="Email" id="email_txt" name="Email" value="<?php echo $row['Email'];?>"></td>  
                            </div>
							</tr>
							</table>
						...
						<button class="wpcf7-submit button--itzel" type="submit"><i class="button__icon fa fa-share" name="Submit"></i><span>Save</span></button>  
                        </form>
						 </div>
