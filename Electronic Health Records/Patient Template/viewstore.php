<?php
include("conn.php");
$query="select * from genericstore";
                    ...
                    <div class="col-md-3 col-sm-4">
                      ...
                      <div class="blog-content">
					   <div class="single-Blog">
                        ...
                        <form class="appointment-form" data-parsley-validate class="form-horizontal form-label-left">
...
<table class="table" id="example">
	...
	<?php while($row=mysqli_fetch_array($result)){ ?>
			...
			<td>
				<a class="btn btn-primary" href="viewonmap.php?edit=<?php echo $row['GenericstoreId']; ?>">Show On Map</a>
			</td>
